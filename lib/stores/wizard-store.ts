...
export const BASE_OPTIONS: WizardOption[] = [
  {
    ...
    description: "Carpeta impresa con diseño personalizado (20x30) + 1 foto individual (15x21) + 4 fotos 4x5 + 1 foto grupal (15x21)"
  },
  {
    id: 2,
    name: "OPCIÓN B", 
    ...
    description: "Carpeta impresa con diseño personalizado (20x30) + 2 fotos individuales (15x21) + 8 fotos 4x5 + 1 foto grupal (15x21)"
  }
];
    ...
    (set, get) => ({
      ...
      toggleIndividualPhoto: (photoId) => {
        ...
        set({ 
          ...
          selectedPhotosLegacy: [...newIndividual, ...state.selectedPhotos.group] // Update legacy format
        });
      },
      ...
      toggleGroupPhoto: (photoId) => {
        ...
        set({ 
          ...
          selectedPhotosLegacy: [...state.selectedPhotos.individual, ...newGroup] // Update legacy format
        });
      },
      ...
      isStepValid: (step) => {
        ...
        switch (step) {
          ...
          case 2: {
            ...
            const hasRequiredIndividual = state.selectedPhotos.individual.length === requiredIndividual;
      ...
      getPhotoValidation: () => {
        ...
        return {
          individual: {
            ...
            isValid: state.selectedPhotos.individual.length === (state.selectedOption?.id === 1 ? 1 : 2)
          },
          group: {
            required: true,
      ...
      calculatePrices: () => {
        ...
        const upsellsPrice = Object.entries(state.selectedUpsells)
          .reduce((total, [upsellId, quantity]) => {
