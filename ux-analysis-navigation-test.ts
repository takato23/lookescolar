...
const userJourneys = [
...

  {
    ...
    painPoints: ['Could skip event detail step', 'Library interface discovery'],
  },
  ...
  high: [
    {
      ...
      description:
        'Two different photo management systems (library vs classic)',
  ...
  medium: [
    {
      ...
      description:
        'Dashboard upload actions go to /admin/photos, not event-specific',
      status: 'BY_DESIGN',
    ...
    },
    {
      ...
      description:
        'Mixed terms: "Biblioteca", "Gestión Clásica", "Subir Fotos"',
      status: 'NEEDS_REVIEW',
