      ...
      return (
        <div className="flex flex-col items-center justify-center space-y-4 py-8">
          ...
          <div className="text-center">
            <h3 className="text-gray-900 dark:text-white mb-2 text-sm font-medium">
              Error al cargar actividad
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-3 max-w-sm text-xs">
      ...
      <div>
        {isLoading ? (
          <div className="space-y-3 py-4">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 p-2">
                <div className="bg-gray-200 dark:bg-gray-700 h-8 w-8 rounded animate-pulse"></div>
                <div className="flex-1 space-y-1">
                  <div className="bg-gray-200 dark:bg-gray-700 h-3 rounded animate-pulse"></div>
                  <div className="bg-gray-200 dark:bg-gray-700 h-2 w-2/3 rounded animate-pulse"></div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-3 py-6">
            <div className="bg-gray-100 dark:bg-gray-800 text-gray-400 rounded-full p-3">
              <Activity className="h-5 w-5" />
            </div>
            <div className="text-center">
              <h3 className="text-gray-900 dark:text-white mb-1 text-sm font-medium">
                Sin actividad reciente
              </h3>
              <p className="text-gray-600 dark:text-gray-400 max-w-sm text-xs">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-900 dark:text-white text-sm leading-tight">
                      {activity.message}
                    </p>
