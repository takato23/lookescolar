...
import { Database, Users, Image, CheckCircle, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Monitoreo del uso de almacenamiento para el plan gratuito (1GB límite)
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{metrics.estimatedStorageUsed}</span>
                  <span className="text-gray-500">de 1GB</span>
                </div>
                <Badge variant={metrics.percentageOfFreeTier < 90 ? 'default' : 'destructive'}>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div>
                  <div className="text-2xl font-bold">{metrics.photosCount.toLocaleString()}</div>
                  <div className="text-sm text-gray-500">Fotos almacenadas</div>
                </div>
                <div>
                  <div className="text-2xl font-bold">
                    {Math.floor(optimizationMetrics.estimatedPhotosForFreeTier - metrics.photosCount).toLocaleString()}
                  </div>
                  <div className="text-sm text-gray-500">Fotos restantes disponibles</div>
                </div>
              </div>
            </div>
          ) : null}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Almacenamiento estimado</div>
              </div>
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Tamaño objetivo por foto</div>
              </div>
            ...
            <div className="flex items-center gap-2 p-4 rounded-lg" 
                 style={{ backgroundColor: projectAnalysis.fitsInFreeTier ? '#f0f9ff' : '#fef2f2' }}>
              {projectAnalysis.fitsInFreeTier ? (
                <CheckCircle className="h-5 w-5 text-green-500" />
              ) : (
                <AlertTriangle className="h-5 w-5 text-red-500" />
              )}
              <span className={projectAnalysis.fitsInFreeTier ? 'text-green-700' : 'text-red-700'}>
                {projectAnalysis.fitsInFreeTier 
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border rounded-lg">
                <h4 className="font-semibold text-green-700">✅ Optimizaciones Activas</h4>
                <ul className="mt-2 space-y-1 text-sm">
                  <li>• Formato WebP (mejor compresión)</li>
                  <li>• Calidad reducida a 50% (vs 72% estándar)</li>
                  <li>• Dimensiones máximas: {optimizationMetrics.maxDimension}px</li>
              ...
              <div className="p-4 border rounded-lg">
                <h4 className="font-semibold text-blue-700">📊 Métricas de Rendimiento</h4>
                <ul className="mt-2 space-y-1 text-sm">
                  <li>• Objetivo: {optimizationMetrics.targetSizeKB}KB por foto</li>
                  <li>• Capacidad teórica: {optimizationMetrics.estimatedPhotosForFreeTier.toLocaleString()} fotos</li>
            ...
            {projectAnalysis.recommendations.length > 0 && (
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-semibold text-yellow-700 mb-2">💡 Recomendaciones</h4>
