...
test.describe('Network Error Handling', () => {
  test('Offline mode handling', async ({ page, context }) => {
    ...
    await expect(
      page.locator('[data-testid="retry-when-online"]')
    ).toBeVisible();
  ...
  test('Slow network recovery', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="slow-connection-notice"]')
    ).toBeVisible();
  ...
  test('Partial data loading', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="photo-card"][data-status="loaded"]')
    ).toBeVisible();
...
test.describe('Authentication and Authorization Errors', () => {
  test('Expired token handling', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="token-expired"]')).toContainText(
      'expirado'
    );
  ...
  test('Invalid token format', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="invalid-token-format"]')
    ).toBeVisible();
    await expect(page.locator('[data-testid="help-text"]')).toContainText(
      'formato válido'
    );
  });
...
test.describe('File Upload Errors', () => {
  ...
  test('Invalid file format', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="file-format-error"]')
    ).toContainText('formato no válido');
  });
  ...
  test('Upload server error', async ({ page }) => {
    ...
    await page.setInputFiles(
      ...
      '__tests__/fixtures/sample-photo.jpg'
    );

    // Should show upload error
    await expect(
      page.locator('[data-testid="upload-server-error"]')
    ).toBeVisible();
  ...
  test('Upload progress interruption', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="upload-interrupted"]')
    ).toBeVisible();
...
test.describe('Payment Processing Errors', () => {
  ...
  test('Payment webhook failure', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="payment-processing"]')
    ).toContainText('procesando');

    // Should provide order reference
    await expect(
      page.locator('[data-testid="payment-reference"]')
    ).toBeVisible();
  });
  ...
  test('Duplicate payment prevention', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="view-existing-order"]')
    ).toBeVisible();
  });
});
...
test.describe('Browser Compatibility Edge Cases', () => {
  test('JavaScript disabled fallback', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="no-javascript-warning"]')
    ).toBeVisible();
  ...
  test('Cookies disabled handling', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="cookies-disabled-warning"]')
    ).toBeVisible();
    ...
    await expect(
      page.locator('[data-testid="limited-functionality-warning"]')
    ).toBeVisible();
  });
  ...
  test('Local storage full error', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="storage-full-warning"]')
    ).toBeVisible();
...
test.describe('Performance Edge Cases', () => {
  test('Very large image handling', async ({ page }) => {
    ...
    const largeImageContainer = page.locator(
      '[data-testid="photo-modal-container"]'
    );
  ...
  test('Extreme viewport sizes', async ({ page }) => {
    ...
    const gridCols = await photoGrid.evaluate(
    ...
    const wideGridCols = await photoGrid.evaluate(
      (el) => getComputedStyle(el).gridTemplateColumns
    );
