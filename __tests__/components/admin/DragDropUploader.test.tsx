...
import { DragDropUploader } from '@/components/admin/photos/DragDropUploader'
...
function createMockFile(name: string, size: number, type: string = 'image/jpeg') {
...
describe('DragDropUploader', () => {
  ...
  describe('Upload Process', () => {
    it('debe subir archivos exitosamente', async () => {
      ...
      await waitFor(() => {
        expect(fetch).toHaveBeenCalledWith('/api/admin/photos/upload', expect.objectContaining({
          method: 'POST',
  ...
  describe('Accessibility', () => {
    it('debe tener labels apropiados', () => {
      ...
      expect(screen.getByLabelText(/seleccionar archivos/i)).toBeInTheDocument()
      expect(screen.getByText('Subir Fotos')).toBeInTheDocument()
    })
