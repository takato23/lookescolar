...
describe('Gallery Links Utility', () => {
  describe('generateFamilyGalleryLink', () => {
    it('should generate unified gallery links when feature flags are enabled', () => {
      ...
      expect(result).toBe(
        'http://localhost:3002/gallery/a7eed8dd-a432-4dbe-9cd8-328338fa5c74?token=4ecebc495344b51b5b3cae049d27edd2'
      );
    });
    ...
    it('should fallback to legacy format when eventId is missing', () => {
      ...
      expect(result).toBe(
        'http://localhost:3002/f/4ecebc495344b51b5b3cae049d27edd2/simple-page'
      );
    });
    ...
    it('should handle missing origin gracefully', () => {
      ...
      expect(result).toContain(
        '/gallery/a7eed8dd-a432-4dbe-9cd8-328338fa5c74?token=4ecebc495344b51b5b3cae049d27edd2'
      );
    });
  });
