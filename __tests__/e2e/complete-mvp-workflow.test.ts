...
describe('MVP Complete Workflow E2E', () => {
  describe('Phase 1: Admin Setup', () => {
    ...
    it('1.3 Create subject with token should work', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/admin/subjects`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
      ...
      console.log(
        '✅ Subject created with token:',
        testSubjectToken.substring(0, 8) + '...'
      );
    });
  });
  ...
  describe('Phase 3: Family Gallery Access', () => {
    it('3.1 Family should access gallery with token', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/family/gallery/${testSubjectToken}`
      );
      ...
      console.log(
        '✅ Family can access gallery with',
    ...
    it('3.2 Public gallery should also work', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/gallery/${testEventId}`
      );
  ...
  describe('Phase 4: Shopping Cart & Checkout', () => {
    ...
    it('4.3 Public checkout should also work', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/gallery/checkout`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('Phase 6: Admin Order Management', () => {
    ...
    it('6.2 Admin should be able to mark order as delivered', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/admin/orders/${testOrderId}`,
        {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('6.3 Export orders should include the test order', async () => {
      const response = await fetch(
        `${TEST_CONFIG.baseUrl}/api/admin/orders/export`,
        {
          headers: {
            Authorization: `Bearer ${adminSession.access_token}`,
          },
  ...
  describe('Phase 7: End-to-End Validation', () => {
    ...
    it('7.3 Security validations should pass', async () => {
      ...
      const invalidTokenResponse = await fetch(
        `${TEST_CONFIG.baseUrl}/api/family/gallery/invalid-token`
      );
      ...
      const sqlInjectionResponse = await fetch(
        `${TEST_CONFIG.baseUrl}/api/family/gallery/'; DROP TABLE subjects; --`
      );
...
async function resetRateLimit() {
  ...
  try {
    await fetch(`${TEST_CONFIG.baseUrl}/api/test/reset-rate-limit`, {
      method: 'POST',
    });
  } catch {
