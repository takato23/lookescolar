/**
 * CATCH-ALL ROUTE para /store/[token]/[...slug]
 * 
 * Esta ruta captura todas las subrutas como:
 * - /store/[token]/checkout
 * - /store/[token]/cart
 * - /store/[token]/photos
 * - /store/[token]/cualquier-otra-ruta
 * 
...
export default async function CatchAllStorePage({ params, searchParams }: PageProps) {
  ...
  console.log(`🔄 [CATCH-ALL] Redirigiendo /store/${token}/${slug.join('/')} → ${redirectUrl}`);
