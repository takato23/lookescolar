...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('📁 [CHECKOUT] Resultado de búsqueda:', { folder, folderError });
    ...
    console.log('📝 [CHECKOUT] Datos de orden a insertar:', JSON.stringify(orderData, null, 2));
    ...
    console.log('📋 [CHECKOUT] Datos completos a enviar:', JSON.stringify(mercadopagoData, null, 2));
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`MercadoPago error: ${errorData.message || 'Unknown error'}`);
      }
      ...
      return NextResponse.json({
        ...
        message: 'Orden creada. Error en MercadoPago, usando URL de desarrollo.',
