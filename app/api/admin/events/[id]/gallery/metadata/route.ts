  ...
  async (req: NextRequest, { params }: { params: { id: string } }) => {
    try {
      ...
      const { data, error } = await supabase.rpc(
        'get_or_create_gallery_metadata',
        {
          p_event_id: eventId,
          p_level_id: level_id,
      ...
      console.error(
        'Error in GET /api/admin/events/[id]/gallery/metadata:',
        error
      );
      return NextResponse.json(
  ...
  async (req: NextRequest, { params }: { params: { id: string } }) => {
    try {
      ...
      if (error) {
        ...
        return NextResponse.json(
          {
            error: 'Failed to update gallery metadata',
      ...
      console.error(
        'Error in POST /api/admin/events/[id]/gallery/metadata:',
        error
      );
