...
export const GET = withAuth(
  async (
    ...
    try {
      ...
      console.error(
        'Error in GET /api/admin/events/[id]/courses/[courseId]/photos:',
        error
      );
...
export const POST = withAuth(
  async (
    ...
    try {
      ...
      const { data: createdAssociations, error: associationError } =
        await supabase
          .from('photo_courses')
          .upsert(associations, {
      ...
      if (associationError) {
        console.error(
          'Error creating photo-course associations:',
          associationError
        );
        return NextResponse.json(
          {
            error: 'Failed to associate photos with course',
      ...
      if (updateError) {
        console.warn(
          'Warning: Failed to update photos with course_id:',
          updateError
        );
      ...
      console.error(
        'Error in POST /api/admin/events/[id]/courses/[courseId]/photos:',
        error
      );
  ...
  async (
    ...
    try {
      ...
      if (deleteError) {
        ...
        return NextResponse.json(
          {
            error: 'Failed to remove photo associations',
      ...
      console.error(
        'Error in DELETE /api/admin/events/[id]/courses/[courseId]/photos:',
        error
      );
