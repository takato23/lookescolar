...
export const GET = withAuth(
  ...
  try {
      ...
      photoQuery = photoQuery.or(
        `course_id.eq.${courseId},student_id.in.(${supabase.rpc('get_students_for_course', { course_id: courseId })})`
      );
      ...
      console.error(
        'Error in GET /api/admin/events/[id]/courses/[courseId]/gallery:',
        error
      );
      return NextResponse.json(
...
export const POST = withAuth(
  ...
  try {
      ...
      console.error(
        'Error in POST /api/admin/events/[id]/courses/[courseId]/gallery/download:',
        error
      );
      return NextResponse.json(
        { error: 'Internal server error' },
