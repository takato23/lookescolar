    ...
    try {
      ...
      const processedCourse = {
        ...
        students: course.students?.map((student: any) => ({
          ...
          last_photo_tagged:
            student.photo_students?.length > 0
      ...
      console.error(
        'Error in GET /api/admin/events/[id]/courses/[courseId]:',
        error
      );
      return NextResponse.json(
...
export const PUT = withAuth(
  async (
    ...
    try {
      ...
      console.error(
        'Error in PUT /api/admin/events/[id]/courses/[courseId]:',
        error
      );
...
export const DELETE = withAuth(
  async (
    ...
    try {
      ...
      console.error(
        'Error in DELETE /api/admin/events/[id]/courses/[courseId]:',
        error
      );
      return NextResponse.json(
        { error: 'Internal server error' },
