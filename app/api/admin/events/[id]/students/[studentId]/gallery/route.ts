...
export const GET = withAuth(
  async (
    req: NextRequest, context: RouteContext<{ id: string; studentId: string }>) => {
  ...
  try {
      ...
      console.error(
        'Error in GET /api/admin/events/[id]/students/[studentId]/gallery:',
        error
      );
      return NextResponse.json(
...
export const POST = withAuth(
  ...
  try {
      ...
      console.error(
        'Error in POST /api/admin/events/[id]/students/[studentId]/gallery/download:',
        error
      );
      return NextResponse.json(
        { error: 'Internal server error' },
