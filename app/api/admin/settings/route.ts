...
const SettingsSchema = z.object({
  ...
  watermarkPosition: z.enum(['bottom-right','bottom-left','top-right','top-left','center']).default('bottom-right'),
  ...
  uploadMaxResolution: z.enum(['1600','1920','2048']).transform(Number).default('1920'),
