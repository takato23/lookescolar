...
const skeletonBaseClass = "animate-pulse bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 bg-[length:200%_100%]";
...
const SkeletonPhotoContent = memo(() => (
  <div className="h-full flex flex-col">
    ...
    {/* Photo info */}
    <div className="p-2 bg-white rounded-b-lg space-y-1">
...
export const SkeletonDetailsPanel = memo(() => (
  <div className="p-4 space-y-4">
    ...
    <div className="aspect-square rounded-lg overflow-hidden">
      <div className={cn(skeletonBaseClass, "w-full h-full")} />
    </div>
