    ...
    <div style={{ padding: '40px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        {events.map((event: any) => (
          <div key={event.id} style={{ 
            padding: '10px', 
            border: selectedEvent === event.id ? '2px solid blue' : '1px solid #ccc',
            margin: '5px 0',
      ...
      {selectedEvent && (
        <div style={{ marginTop: '20px' }}>
          ...
          <a href={`/admin/photos?event_id=${selectedEvent}`} 
             style={{ padding: '10px 20px', backgroundColor: '#007bff', color: 'white', textDecoration: 'none' }}>
      ...
      <div style={{ marginTop: '30px', fontSize: '12px', color: '#666' }}>
        <h4>🔧 Debug Info:</h4>
        <p>localStorage 'le:lastEventId': {localStorage.getItem('le:lastEventId') || 'null'}</p>
