...
function categorizePhotoUsage() {
  ...
  const testFiles = ['__tests__/', 'tests/', 'scripts/test-'];
  ...
  try {
    ...
    console.log('\n🎯 PLAN DE ACCIÓN:');
    console.log(
      '1. ✅ PRIMERO: Arreglar APIs críticas que están causando errores 500'
    );
    console.log('2. ⚡ SEGUNDO: Servicios core (lib/services/)');
    console.log('3. 📊 TERCERO: Scripts de operaciones importantes');
    console.log(
      '4. 🧪 ÚLTIMO: Tests (funcionarán cuando APIs estén arregladas)'
    );
