...
async function setupHierarchicalSystem() {
  ...
  if (foldersError) {
    console.log(
      '❌ Folders table missing - this should exist from 20250825_unified_photo_system_optimized.sql'
    );
    console.log(
      '⚠️ Please ensure the unified photo system migration was applied first'
    );
  } else {
  ...
  if (assetsError) {
    console.log(
      '❌ Assets table missing - this should exist from 20250825_unified_photo_system_optimized.sql'
    );
    console.log(
      '⚠️ Please ensure the unified photo system migration was applied first'
    );
  ...
  console.log('\nNext steps needed:');
  console.log(
    '1. Ensure folders and assets tables exist from previous migrations'
  );
  console.log(
    '2. Create courses, course_members, folder_courses, asset_subjects tables'
  );
